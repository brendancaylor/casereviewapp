...
GO
ALTER TABLE [dbo].[CaseReviewWorkSheet] DROP CONSTRAINT [DF__tmp_ms_xx__CaseR__160F4887];
...
ALTER TABLE [dbo].[CaseReviewType]
    ADD [TypeName] NVARCHAR (250) NOT NULL;
...
GO
ALTER TABLE [dbo].[CaseReviewWorkSheet] ALTER COLUMN [CaseReviewTypeID] INT NULL;
